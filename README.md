...
A command line interface for WhatsApp, originally created by [Normen](https://github.com/normen/whatscli). This fork updates dependencies, fixes compatibility issues, and adds improvements for modern WhatsApp protocols.
